...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_forms_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/forms.js */ "./src/js/components/forms.js");
/* harmony import */ var _components_sprite_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/sprite.js */ "./src/js/components/sprite.js");
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.form', rules1, checks, afterForm);
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  resizableSwiper('(max-width: 576px)', '.services__slider', {
    spaceBetween: 20,
    slidesPerView: 'auto',
    loop: true
  });
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const currentFrame = index => `./img/animation/pic_${index.toString().padStart(5, '0')}.webp`;
  const arrImages = [];
